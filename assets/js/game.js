...
var endGame = function() {
    ...
    //check localStorage for high score, if it's not there, use )
    ...
    if (playerInfo.money > highScore) {
        ...
        window.alert("You beat the high score! " + playerInfo.name + " now has the high score of " + playerInfo.money + ".");
    } else {
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt (
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one: 1 for REFILL, 2 for UPGRADE, and 3 for LEAVE."
    );
